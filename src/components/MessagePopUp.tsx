...
export default function MessagePopUp(props) {
  return (
    <>
      <Box width={350} ml={3} height={600} bg={"white"} borderRadius={10}>
        <Box width={350} height={150} bg="#596334" borderTopLeftRadius={10} borderTopRightRadius={10}>
          <Flex direction="column" justifyContent={"flex-end"} alignItems={"flex-start"}>
            <Text m={5} fontSize="2xl" color={"white"}>
              {props.messageTitle}
            </Text>
            <Text ml={5} color="#DFED98">
              {props.adminName}
            </Text>
          </Flex>
        </Box>
